...
class CA_Admin
{
	...
	public function render_settings_page()
	{
		...
		<div class="wrap ca-admin-wrap">
			...
			<div class="ca-admin-card" style="max-width:720px; margin-top:32px;">
				<h2 class="ca-admin-card-title"><?php esc_html_e('Courses', 'rtr-custom-assessment'); ?></h2>
				<p class="description">
					<?php esc_html_e('Course access, orders, catalog, and token settings are managed on the Courses screen.', 'rtr-custom-assessment'); ?>
				</p>
				<p>
					<a href="<?php echo esc_url(add_query_arg(array('page' => 'custom-assessment-courses', 'ca_course_tab' => 'settings'), admin_url('admin.php'))); ?>" class="button button-primary">
						<?php esc_html_e('Open Courses', 'rtr-custom-assessment'); ?>
					</a>
				</p>
			</div>
		</div>
	...
	public function render_hub_page()
	{
		...
		$courses_url = add_query_arg(
			array(
				'page' => 'custom-assessment-courses',
				'ca_course_tab' => 'dashboard',
			),
			admin_url('admin.php')
		);
		?>
		<div class="wrap ca-admin-wrap ca-assessment-hub-wrap">
			...
			<p class="description"><?php esc_html_e('Open an assessment or course section to view its dashboard and records.', 'rtr-custom-assessment'); ?></p>
			<div class="ca-dashboard-hub-grid">
				...
				<a class="ca-dashboard-hub-card" href="<?php echo esc_url($courses_url); ?>">
					<h2><?php esc_html_e('Courses', 'rtr-custom-assessment'); ?></h2>
					<p><?php esc_html_e('Paid course access, orders, and tokens', 'rtr-custom-assessment'); ?></p>
				</a>
			</div>
		</div>
		<?php
