	...
	public function enqueue_assets() {
		...
		wp_localize_script( 'ca-scripts', 'CA_Config', array(
			...
			'labels'         => array(
				...
				'submit'        => __( 'Submit Assessment', CA_TEXT_DOMAIN ),
				'start'         => __( 'Start Assessment', CA_TEXT_DOMAIN ),
				'loading'       => __( 'Loading…', CA_TEXT_DOMAIN ),
				'error_answer'  => __( 'Please select an answer before continuing.', CA_TEXT_DOMAIN ),
				'error_generic' => __( 'Something went wrong. Please try again.', CA_TEXT_DOMAIN ),
			),
		) );
	}
			...
			<div class="ca-modal-panel">
				...
				<div class="ca-progress-container" id="ca-progress-container" aria-hidden="true">
					<div class="ca-progress-track">
						<div class="ca-progress-bar" id="ca-progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%"></div>
					</div>
				...
				<div class="ca-modal-body" id="ca-modal-body">
					...
					<div id="ca-screen-info" class="ca-screen ca-screen-active">
						<div class="ca-screen-content">
							...
							<p class="ca-screen-subtitle">Fill in your details below to begin the assessment. All information is kept confidential.</p>

							<form id="ca-info-form" class="ca-form" novalidate>
								<div class="ca-form-row ca-form-row--2col">
									<div class="ca-field-group">
										<label for="ca-first-name" class="ca-label">First Name <span class="ca-required" aria-hidden="true">*</span></label>
										<input type="text" id="ca-first-name" name="first_name" class="ca-input" placeholder="Jane" autocomplete="given-name" required>
									</div>
									<div class="ca-field-group">
										<label for="ca-last-name" class="ca-label">Last Name <span class="ca-required" aria-hidden="true">*</span></label>
										<input type="text" id="ca-last-name" name="last_name" class="ca-input" placeholder="Doe" autocomplete="family-name" required>
									</div>
								</div>

								<div class="ca-form-row">
									<div class="ca-field-group">
										<label for="ca-email" class="ca-label">Email Address <span class="ca-required" aria-hidden="true">*</span></label>
										<input type="email" id="ca-email" name="email" class="ca-input" placeholder="jane@example.com" autocomplete="email" required>
									</div>
								</div>

								<div class="ca-form-row ca-form-row--2col">
									<div class="ca-field-group">
										<label for="ca-phone" class="ca-label">Phone Number <span class="ca-required" aria-hidden="true">*</span></label>
										<input type="tel" id="ca-phone" name="phone" class="ca-input" placeholder="+1 (555) 000-0000" autocomplete="tel" required>
									</div>
									<div class="ca-field-group">
										<label for="ca-job-title" class="ca-label">Job Title <span class="ca-required" aria-hidden="true">*</span></label>
										<input type="text" id="ca-job-title" name="job_title" class="ca-input" placeholder="Founder & CEO" autocomplete="organization-title" required>
									</div>
								</div>
								...
								<div class="ca-form-actions">
									<button type="submit" class="ca-btn ca-btn--primary ca-btn--lg" id="ca-start-btn">
										...
										<span class="ca-btn-loading" aria-hidden="true">
											<svg class="ca-spinner" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" stroke-dasharray="60" stroke-dashoffset="20" stroke-linecap="round"/></svg>
										</span>
										<svg class="ca-btn-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
									</button>
								</div>
							</form>
						</div>
					...
					<div id="ca-screen-questions" class="ca-screen">
						<div class="ca-screen-content ca-screen-content--question">
							...
							<div class="ca-question-scale-note" aria-label="Rating scale instructions">
								Rate this statement on a scale of 1 to 5, where <strong>1</strong> means it is least like you and <strong>5</strong> means it is most like you.
							</div>
							...
							<div class="ca-answer-group" id="ca-answer-group" role="group" aria-labelledby="ca-question-text">
								...
								<label class="ca-answer-option" data-value="<?php echo esc_attr( $i ); ?>">
									<input type="radio" name="ca_answer" value="<?php echo esc_attr( $i ); ?>" class="ca-answer-radio" aria-label="<?php echo esc_attr( $i ); ?>">
					...
					<div id="ca-screen-loading" class="ca-screen ca-screen-loading">
						<div class="ca-loading-spinner">
							<svg class="ca-spinner ca-spinner--lg" viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" stroke-dasharray="60" stroke-dashoffset="20" stroke-linecap="round"/></svg>
							<p>Loading…</p>
						</div>
					</div>
